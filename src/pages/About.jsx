  ...
  return (
    <div className="container mx-auto flex flex-col px-8 pt-16">
      <div className="flex flex-row justify-between pt-8 lg:pt-24">
        ...
        <img src={logo} alt="" className="m-auto  hidden h-48 lg:flex" />
      </div>
      <div className="flex">
        <div className="mr-auto flex flex-col pt-8 lg:w-1/2">
          <span className="pb-4">
        ...
        <div className="m-auto hidden lg:flex">Flagi? Obrazek?</div>
      </div>
      <div id="mission"></div>
      <div className="pb-32 pt-32">
        ...
        <div className="grid w-full grid-cols-1 flex-col gap-4 lg:grid-cols-2">
          ...
          <p>
            <img src={logo} alt="" className="hidden w-48 lg:flex" />
          </p>
      ...
      <div className="pb-32">
        ...
        <ul className="grid grid-cols-2 justify-between gap-4 md:grid-cols-5">
          ...
          <li className="mx-auto w-[150px]">
            <img src={nepal} className="h-[75px] hover:scale-105 transition-all ease-in-out duration-300" />
          </li>
          <li>
            <img
              src={phil}
