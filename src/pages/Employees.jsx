      ...
      <div className="pb-32">
        ...
        <div className="flex flex-col gap-2 lg:flex-row ">
          <p className="lg:w-1/2">
            W HoldHand ciągle rozwijamy nasze usługi i portfolio klientów, dążąc
            do świadczenia najwyższej jakości usług w branży. Chociaż w tym
            momencie nie prowadzimy aktywnej rekrutacji do naszego zespołu
