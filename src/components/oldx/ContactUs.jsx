    ...
    <form ref={form} onSubmit={sendEmail} className=''>
      <ul className='flex flex-col gap-4 w-full'>
        ...
        <li className='flex flex-col w-full'>
          ...
          <textarea
            name='message'
            class='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline resize-none h-[150px]'
          />
        </li>
        <li>
          {/* {statusMessage} */}
          {isLoading ? (
            ...
            <div className='flex'>
              ...
              />{' '}
              <p className='text-green-500 my-auto px-4'>{statusMessage}</p>
            </div>
          )}
